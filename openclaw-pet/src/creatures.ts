...
function lobsterSvg(settings: LobsterSettings = {}): string {
  ...
  const standardClaws = `<g data-layer="claws" class="lob-claw lob-claw--l"><path d="M20 42C5 37 0 47 5 57C10 67 20 62 25 52C28 45 25 42 20 42Z" fill="${flavor === "chimera" ? "#4a7dfc" : claw}" stroke="#fff" stroke-width="3" stroke-linejoin="round"/></g><g data-layer="claws" class="lob-claw lob-claw--r"><path d="M100 42C115 37 120 47 115 57C110 67 100 62 95 52C92 45 95 42 100 42Z" fill="${flavor === "chimera" ? "#f4b840" : claw}" stroke="#fff" stroke-width="3" stroke-linejoin="round"/></g>`;
  ...
  const canonicalOverlay: Record<string, string> = {
    ...
    nebula: `<g data-layer="nebula"><circle cx="38" cy="52" r="1" fill="#fff"/><circle cx="52" cy="70" r="1.2" fill="#fff"/><circle cx="84" cy="48" r="1.4" fill="#fff"/><circle cx="66" cy="86" r="1" fill="#fff"/><circle cx="72" cy="60" r="1.6" fill="#8be9fd"/><circle cx="46" cy="40" r="1.4" fill="#ff9de2"/><path d="M60 52L61.5 55.5L65 57L61.5 58.5L60 62L58.5 58.5L55 57L58.5 55.5Z" fill="#fff"/></g>`,
    banana: `<g data-layer="banana" fill="#8a6430"><rect x="56" y="8" width="8" height="6" rx="2.5"/><ellipse cx="60" cy="91" rx="6" ry="3.5"/><circle cx="37" cy="48" r="2.5"/><circle cx="79" cy="55" r="2"/><circle cx="47" cy="70" r="1.8"/><circle cx="72" cy="79" r="2.3"/></g>`,
    ...
    clawtron: `<g data-layer="clawtron"><g fill="none" stroke="#5f6a75" stroke-width="1.5"><path d="M28 56Q60 66 92 56"/><path d="M34 74Q60 82 86 74"/></g><g fill="#5f6a75"><circle cx="36" cy="61" r="1.4"/><circle cx="60" cy="64" r="1.4"/><circle cx="84" cy="61" r="1.4"/></g><circle cx="89" cy="7" r="3" fill="#ff4444"/></g>`,
    ...
    sourdough: `<g data-layer="sourdough"><g fill="none" stroke="#a8763e" stroke-width="2.5"><path d="M38 23Q45 29 52 30"/><path d="M52 17Q59 24 66 25"/><path d="M67 18Q74 24 81 25"/></g><g fill="#fff" opacity=".5"><circle cx="34" cy="39" r="1.2"/><circle cx="86" cy="38" r="1"/><circle cx="45" cy="57" r="1.4"/><circle cx="74" cy="62" r="1.1"/><circle cx="56" cy="78" r="1"/><circle cx="83" cy="75" r="1.3"/></g></g>`,
    zombie: `<g data-layer="zombie"><g fill="none" stroke="#5a6b52" stroke-width="2"><path d="M32 24Q47 19 61 23"/><path d="M38 19L40 26M46 18L47 25M54 19L53 26"/><path d="M57 72Q72 78 87 72"/><path d="M65 72L63 79M73 73L72 80M81 71L83 78"/></g><ellipse cx="35" cy="61" rx="9" ry="6" fill="#86987a" opacity=".8" transform="rotate(-18 35 61)"/></g>`,
    ...
    disco: `<g data-layer="disco" fill="#fff"><rect x="42" y="18" width="4" height="4" opacity=".3"/><rect x="52" y="16" width="4" height="4" opacity=".5"/><rect x="63" y="17" width="4" height="4" opacity=".25"/><rect x="74" y="20" width="4" height="4" opacity=".4"/><rect x="31" y="40" width="4" height="4" opacity=".4"/><rect x="53" y="39" width="4" height="4" opacity=".25"/><rect x="65" y="42" width="4" height="4" opacity=".5"/><rect x="86" y="40" width="4" height="4" opacity=".3"/><rect x="39" y="59" width="4" height="4" opacity=".25"/><rect x="51" y="62" width="4" height="4" opacity=".45"/><rect x="68" y="60" width="4" height="4" opacity=".3"/><rect x="80" y="58" width="4" height="4" opacity=".5"/><rect x="49" y="79" width="4" height="4" opacity=".35"/><rect x="70" y="80" width="4" height="4" opacity=".25"/></g>`,
    ...
    geode: `<g data-layer="geode"><polygon points="70,34 80,30 78,44" fill="#9b6ff0"/><polygon points="82,46 94,42 88,58" fill="#b48ef0"/><polygon points="72,58 84,62 74,74" fill="#7a4fd0"/><polygon points="86,68 96,64 90,80" fill="#9b6ff0"/><circle cx="90" cy="50" r="1.8" fill="#fff"/></g>`,
    ghost: `<g data-layer="ghost" opacity=".48"><path d="M28 82Q35 70 42 82T56 82T70 82T84 82T98 82" fill="none" stroke="#fff" stroke-width="3"/></g>`,
    cottoncandy: `<path data-layer="cottoncandy" d="M60 8C88 8 104 32 104 52C104 72 90 90 76 95L76 104L66 104L66 96C64 96.8 62 97.1 60 97.1Z" fill="#a5c6f0" opacity=".8"/>`,
    cryptid: `<g data-layer="cryptid" opacity=".3"><ellipse cx="60" cy="53" rx="32" ry="42" fill="#b9c5d1"/><path d="M35 22L24 8M85 22L96 8" stroke="#b9c5d1" stroke-width="4"/></g>`,
    invisible: `<g data-layer="invisible" opacity=".18"><path d="M30 32Q60 4 90 32" stroke="#dce8f2" stroke-width="2" fill="none"/></g>`,
  };
