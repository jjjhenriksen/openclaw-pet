...
import { svg, type TemplateResult } from "./canonical-svg-template.js";
type LobsterPasserKind = "stranger" | "crab" | "snail" | "duck" | "jellyfish";
type LobsterPetAccessory = NonNullable<import("./pet-controller.js").LobsterSettings["accessory"]>;
type LobsterPetAntennae = NonNullable<import("./pet-controller.js").LobsterSettings["antennae"]>;
type LobsterPetPaletteId = import("./pet-controller.js").LobsterFlavor;
import {
  CHIMERA_STITCHES,
  ECLIPSE_CORONA,
  NOTEXTURE_CHECKER,
